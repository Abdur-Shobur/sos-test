...
import { AffiliateRejectedRequestProduct } from '../../../api/vendor/apiVendor';
import { NoDataFound } from '../../../components/table/TableComponents';

function AffiliateRejectedRequest() {
	const [page, setPage] = useState(null);
	const [search, setSearch] = useState(' ');
	const { searchHandler } = useDebounce(setSearch, setPage);
	const { isLoading, products, refetch } = AffiliateRejectedRequestProduct(
		page,
		search
	);
	...
	return (
		<div className="ec-content-wrapper">
			<Helmet>
				<title>Rejected Request Product-SOS</title>
			</Helmet>
...
export default AffiliateRejectedRequest;

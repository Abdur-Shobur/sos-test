...
import Slider from '../../affiliates-dashboard/products/Slider';
...
function VendorProductPreviewCpoy() {
	const { id = 5 } = useParams();

	const { data, isLoading } = useQuery(
		['get_preview_vendor_own_product', id],
		() => {
...
export default VendorProductPreviewCpoy;

...
function ProductDEtailsPending() {
	...
	const { data } = useQuery(['get_pending_details_product_data', id], () => {
											...
											<ul className="product-color">
												{product?.colors?.map((e) => (
													<li key={e?.id} className="color">
														<span style={{ backgroundColor: e.code }}></span>
													</li>
												))}
											</ul>
...
export default ProductDEtailsPending;

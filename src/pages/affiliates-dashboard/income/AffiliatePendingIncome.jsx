...
import { GetBalanceHistoryPending } from '../../../api/affiliate/apiAffiliate';
import { NoDataFound } from '../../../components/table/TableComponents';

function AffiliatePendingIncome() {
	const [page, setPage] = useState(null);
	const [search, setSearch] = useState(' ');
	const { searchHandler } = useDebounce(setSearch, setPage);
	const { getData, isLoading } = GetBalanceHistoryPending(page, search);
	useEffect(() => {
...
export default AffiliatePendingIncome;

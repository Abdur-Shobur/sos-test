...
const CreateAffiliatesServices = () => {
  ...
  const handleSubmitCompanions = async (e) => {
    ...
    try {
      ...
      console.log(getState1, service2Data);
      if (data.data?.data !== "success") {
        ...
        navigate("/affiliates-dashboard/all-service");
        tost(data?.data?.message);
      }
  ...
  return (
    <div style={{ margin: "20px" }}>
      <Helmet>
        <title>Affiliates Create Service-SOS</title>
      </Helmet>
...
export default CreateAffiliatesServices;

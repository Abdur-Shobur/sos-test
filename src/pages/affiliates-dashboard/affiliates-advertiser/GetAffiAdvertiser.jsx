...
import { GetAffiliatesAdvertiserData } from "../../../api/admin/affiliatesAPI";

function GetAffiAdvertiser() {
  const [page, setPage] = useState(null);
  const { advertiserData, isLoading, refetch } =
    GetAffiliatesAdvertiserData(page);
...
export default GetAffiAdvertiser;

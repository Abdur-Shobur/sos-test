...
import Aos from 'aos';
import { GetOrderHistoryDelivered } from '../../../api/affiliate/apiAffiliate';

function OrderHistoryDelivered() {
	const [page, setPage] = useState(null);
	const [search, setSearch] = useState(' ');
	const { searchHandler } = useDebounce(setSearch, setPage);
	const { getData, isLoading } = GetOrderHistoryDelivered(page, search);
	useEffect(() => {

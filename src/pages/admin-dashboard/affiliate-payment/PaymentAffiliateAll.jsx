...
import { GetAllWithDraw } from '../../../api/admin/apiAdmin';
import { NoDataFound } from '../../../components/table/TableComponents';

function PaymentAffiliateAll() {
	...
	// get withdraw
	const { allReq, isLoading, refetch } = GetAllWithDraw(page, search);
	...
	return (
		<div className="ec-content-wrapper">
			<Helmet>
				<title>Affiliate Payment-SOS</title>
			</Helmet>
...
export default PaymentAffiliateAll;

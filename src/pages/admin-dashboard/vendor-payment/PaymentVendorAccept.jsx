...
function PaymentVendorAccept() {
	...
	return (
		<div className="ec-content-wrapper">
			<Helmet>
				<title>Vendor Payment Accept-SOS</title>
			</Helmet>
			<div className="content">
				<Breadcrumb searchHandler={searchHandler} text="Accept" />
...
export default PaymentVendorAccept;

...
const ServiceSubCategoryModal = ({ clickId, subFetch }) => {
    ...
    switch (action.type) {
      ...
      case "API_DATA":
        return {
          ...
          service_category_id: action?.payload?.service_category_id,
        };
  ...
  useEffect(() => {
    const getDataEditData = async () => {
      setLoadingData(true);
      const res = await http.get(`/admin/service-sub-category/${clickId}`);
  ...
  const handleSubmitData = async (e) => {
    ...
    setLoading(false);
    try {
      const data = await http.post(`/admin/service-sub-category/${clickId}`, {
        ...state,
        _method: "PUT",
      });
...
export default ServiceSubCategoryModal;

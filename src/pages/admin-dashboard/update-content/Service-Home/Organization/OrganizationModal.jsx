...
const OrganizationModal = ({ clickId, organizationRefetch }) => {
	...
	useEffect(() => {
		const getDataEditData = async () => {
			setLoadingData(true);
			const res = await http.get(`/admin/organization/${clickId}`);
	...
	const handleSubmitData = async (e) => {
		...
		try {
			const data = await http.put(`/admin/organization/${clickId}`, state);

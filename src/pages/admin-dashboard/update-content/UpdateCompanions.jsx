...
import Aos from 'aos';
import { GetAdminCompanionData } from '../../../api/admin/apiAdmin';
...
function UpdateCompanions() {
	...
	const {
		companionData,
		refetch: companionFefetch,
		isLoading: compainLoading,
	} = GetAdminCompanionData();

	const handleDelete = (id) => {
		const del = () =>
			http.delete(`/admin/companion/${id}`).then((res) => {
	...
	return (
		<div className="ec-content-wrapper">
			<Helmet>
				<title>Admin Campanions Content-SOS</title>
			</Helmet>
			<div className="content">
				<div className="breadcrumb-wrapper breadcrumb-contacts">
					<div>
						<h1>All Companions</h1>
					...
					<div>
						<Link className="btn btn-primary" to="/admin/create-companions">
							Create Companion
						</Link>
					</div>
				</div>
                                ...
                                /> */}
															...
															<td>
																<div>
																	...
																	<CompanionsModal
																		companionFefetch={companionFefetch}
																		clickId={clickId}
																	/>
																	<button
...
export default UpdateCompanions;

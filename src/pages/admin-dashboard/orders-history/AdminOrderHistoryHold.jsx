...
import { GetOrdersHold } from '../../../api/admin/apiAdmin';
...
function AdminOrderHistoryHold() {
	const [page, setPage] = useState(null);
	const [search, setSearch] = useState(' ');
	const { searchHandler } = useDebounce(setSearch, setPage);

	// get affiliates
	const { getData, isLoading, refetch } = GetOrdersHold(page, search);
	...
	return (
		<div className="ec-content-wrapper">
			<Helmet>
				<title>Manage Orders Hold-SOS</title>
			</Helmet>
...
export default AdminOrderHistoryHold;

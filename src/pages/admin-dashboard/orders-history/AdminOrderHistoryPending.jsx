...
import { GetOrdersPending } from '../../../api/admin/apiAdmin';
...
function AdminOrderHistoryPending() {
	const [page, setPage] = useState(null);
	const [search, setSearch] = useState(' ');
	const { searchHandler } = useDebounce(setSearch, setPage);

	// get affiliates
	const { getData, isLoading, refetch } = GetOrdersPending(page, search);
	...
	return (
		<div className="ec-content-wrapper">
			<Helmet>
				<title>Manage Orders Pending-SOS</title>
			</Helmet>
...
export default AdminOrderHistoryPending;

...
import { GetOrdersAll } from '../../../api/admin/apiAdmin';
...
function AdminOrderHistoryAll() {
	const [page, setPage] = useState(null);
	const [search, setSearch] = useState(' ');
	const { searchHandler } = useDebounce(setSearch, setPage);

	// get affiliates
	const { getData, isLoading, refetch } = GetOrdersAll(page, search);
	...
	return (
		<div className="ec-content-wrapper">
			<Helmet>
				<title>Manage Orders All-SOS</title>
			</Helmet>
...
export default AdminOrderHistoryAll;

...
import { GetOrdersProgress } from '../../../api/admin/apiAdmin';
...
function AdminOrderHistoryProgress() {
	const [page, setPage] = useState(null);
	const [search, setSearch] = useState(' ');
	const { searchHandler } = useDebounce(setSearch, setPage);

	// get affiliates
	const { getData, isLoading, refetch } = GetOrdersProgress(page, search);
	...
	return (
		<div className="ec-content-wrapper">
			<Helmet>
				<title>Manage Orders In Progress-SOS</title>
			</Helmet>
			<div className="content">
				<BreadCrumb searchHandler={searchHandler} title="Orders In Progress" />
...
export default AdminOrderHistoryProgress;

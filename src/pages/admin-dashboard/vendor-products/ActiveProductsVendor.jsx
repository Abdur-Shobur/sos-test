...
import { GetVendorProductActive } from '../../../api/admin/vendorsProductAPI';
function ActiveProductsVendor() {
	const [page, setPage] = useState(null);
	const [search, setSearch] = useState(' ');
	const { searchHandler } = useDebounce(setSearch, setPage);

	// get product
	const { products, isLoading, refetch } = GetVendorProductActive(page, search);
	...
	return (
		<div className="ec-content-wrapper">
			<Helmet>
				<title>Active Product Vendor-SOS</title>
			</Helmet>
...
export default ActiveProductsVendor;

...
import { AffiliatesRejectedProduct } from '../../../api/admin/affiliateProduct';
import { NoDataFound } from '../../../components/table/TableComponents';

function RejectedRequestAffiliate() {
	const [page, setPage] = useState(null);
	const [search, setSearch] = useState(' ');
	const { searchHandler } = useDebounce(setSearch, setPage);

	const { isLoading, products, refetch } = AffiliatesRejectedProduct(
		page,
		search
	);
...
export default RejectedRequestAffiliate;

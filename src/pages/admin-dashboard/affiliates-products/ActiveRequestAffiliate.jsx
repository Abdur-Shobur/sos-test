...
import { AffiliatesActiveProduct } from '../../../api/admin/affiliateProduct';
import { NoDataFound } from '../../../components/table/TableComponents';

function ActiveRequestAffiliate() {
	const [page, setPage] = useState(null);
	const [search, setSearch] = useState(' ');
	const { searchHandler } = useDebounce(setSearch, setPage);

	const { products, isLoading, refetch } = AffiliatesActiveProduct(
		page,
		search
	);
...
export default ActiveRequestAffiliate;

...
import { AffiliatesPending } from '../../../api/admin/affiliatesAPI';
...
function PendingAffiliates() {
	...
	// get affiliates
	const { affiliates, isLoading, refetch } = AffiliatesPending(page, search);
	...
	return (
		<div className="ec-content-wrapper">
			<Helmet>
				<title>Pending Affiliates-SOS</title>
			</Helmet>
